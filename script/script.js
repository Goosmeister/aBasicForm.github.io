...
const msg = "Your Friend " + name + ", the " + color + " " + animalName + " with the " + number + " " + partName + " lives in a " + senseArray + " " + areaName + " with his best friend " + word + "! Sorry He can't be your friend at the moment, he already has one.";
console.log(msg);
